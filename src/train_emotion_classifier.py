...
from src.utils.trainingmonitor import TrainingMonitor
import os
...
for dataset_name in datasets:
    ...
    training_monitor = TrainingMonitor(figPath)

    callbacks = [model_checkpoint, csv_logger, early_stop, reduce_lr, training_monitor]
